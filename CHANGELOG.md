...
- implemented the abstract class for the secondary methods
- tried replacing outpirnt with logging according to the feedback
- implemented the sort method which I didnt know how previously
